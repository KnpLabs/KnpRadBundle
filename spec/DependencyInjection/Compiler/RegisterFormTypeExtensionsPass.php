...
class RegisterFormTypeExtensionsPass extends ObjectBehavior
{
    /**
    ...
    )
    {
        ...
        $container->setDefinition('app.form.extension.edit_cheese_type_extension', ANY_ARGUMENT)->shouldNotBeCalled();

        $container->hasDefinition('app.form.extension.mouse_type_extension')->willReturn(true);
        $container->setDefinition('app.form.extension.mouse_type_extension', ANY_ARGUMENT)->shouldNotBeCalled();
    ...
    function it_should_not_register_form_types_if_form_extension_service_is_not_loaded($container)
    {
        ...
        $container->setDefinition('app.form.extension.cheese_type_extension', ANY_ARGUMENT)->shouldNotBeCalled();
        $container->setDefinition('app.form.extension.edit_cheese_type_extension', ANY_ARGUMENT)->shouldNotBeCalled();
        $container->setDefinition('app.form.extension.mouse_type_extension', ANY_ARGUMENT)->shouldNotBeCalled();
